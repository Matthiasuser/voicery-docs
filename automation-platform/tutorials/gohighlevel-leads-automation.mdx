...
<Frame>
  ![Creating new AI assistant](/resources/tutorials/gohighlevel/01-create-assistant.png)
</Frame>
...
<Frame>
  ![Assistant basic settings configuration](/resources/tutorials/gohighlevel/02-assistant-basic-settings.png)
</Frame>
...
<Frame>
  ![Navigating to Prompts and Tools tab](/resources/tutorials/gohighlevel/03-call-variables-tab.png)
</Frame>

1. **Go to the second tab** "Prompts and Tools"
2. **Locate the "Call Variables" section**

<video autoPlay muted loop playsinline src="/resources/tutorials/gohighlevel/04-add-email-variable.mp4" />
...
<Frame>
  ![Post-call variables configuration](/resources/tutorials/gohighlevel/05-post-call-variables.png)
</Frame>
...
<Frame>
  ![Understanding the status variable](/resources/tutorials/gohighlevel/06-status-variable-explanation.png)
</Frame>
...
<Frame>
  ![Creating new campaign](/resources/tutorials/gohighlevel/07-create-campaign.png)
</Frame>
...
<Frame>
  ![Selecting new contact trigger](/resources/tutorials/gohighlevel/12-select-new-contact-trigger.png)
</Frame>
...
<Frame>
  ![Mapping phone number from trigger data](/resources/tutorials/gohighlevel/19-map-phone-number.png)
</Frame>
...
<Frame>
  ![Completed variable mapping](/resources/tutorials/gohighlevel/21-variable-mapping-complete.png)
</Frame>
...
<Frame>
  ![Verifying lead in platform](/resources/tutorials/gohighlevel/23-verify-lead-added.png)
</Frame>
...
<Frame>
  ![Publishing the automation](/resources/tutorials/gohighlevel/24-publish-automation.png)
</Frame>

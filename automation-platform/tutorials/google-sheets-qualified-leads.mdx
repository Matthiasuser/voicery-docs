...
<Frame>
  ![Webhook configuration settings](/resources/tutorials/qualified-leads/06-webhook-settings.png)
</Frame>
...
<Frame>
  ![Post-call variables configuration](/resources/tutorials/qualified-leads/07-post-call-variables.png)
</Frame>
